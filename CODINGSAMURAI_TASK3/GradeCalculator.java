...
public class GradeCalculator {
    ...
    public static void main(String[] args) {
        ...
        while (calculateAnother) {
            ...
            double midtermGrade = getGrade(scanner, "Enter MID-TERM GRADE: ");
            double finalExamGrade = getGrade(scanner, "Enter END-TERM GRADE: ");
            double participationGrade = getGrade(scanner, "Enter VIVA GRADE: ");
